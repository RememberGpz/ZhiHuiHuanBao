...
import com.lee.zhihuihuanbao.WXPayBean;
...
public class PayUtil {
     ...
     * 确认微信支付
     */
    public void CheckWXPay(Activity activity, WXPayBean.ResultBean result, int place) {
        this.place = place;
        // 判断当前微信版本是否支持微信支付
        ...
        if (isPaySupported) {
            ...
            ToastUtil.showToast("当前版本不支持微信支付，请升级微信后重试");
        }
    }
     ...
     * 微信支付
     */
    private void weChatPay(WXPayBean.ResultBean result) {
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        // ((OrderDetailActivity) activity).setNeedRefresh(status);
                        Toast.makeText(activity, "支付成功", Toast.LENGTH_SHORT).show();
                        mPaySuccessListener.aliPay();
                    } else {
                ...
                case SDK_AUTH_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000") && TextUtils.equals(authResult.getResultCode(), "200")) {
                        ...
                        // 其他状态值则为授权失败
                        ToastUtil.showToast("授权失败" + String.format("authCode:%s"));
                    }
                    break;
                }
                default:
    ...
    //         * orderInfo的获取必须来自服务端；
    //         */
    //        String bizContent = "biz_content={\\\"timeout_express\\\":\\\"30m\\\",\\\"seller_id\\\":\\\"2088421964684352\\\",\\\"product_code\\\":\\\"QUICK_MSECURITY_PAY\\\",\\\"total_amount\\\":\\\"0.01\\\",\\\"subject\\\":\\\"培训直播平台支付宝充值\\\",\\\"body\\\":\\\"培训直播平台支付宝充值\\\",\\\"out_trade_no\\\":\\\"20161111120612116\\\"}";
    ...
    public void setPaySuccessListener(PaySuccessListener mPaySuccessListener) {
